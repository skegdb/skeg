...
pub use flags::Flags;
pub use frame::{
    Frame, FrameHeader, FrameParser, HEADER_LEN, MAGIC, MAX_FRAME_SIZE, VERSION, VERSION_V1,
    VERSION_V2, encode_frame, encode_frame_versioned,
};
pub use op::Op;
pub use request::{
...
pub use vector::{
    ...
    decode_vname_payload, decode_vsearch_payload, decode_vsearch_response, decode_vset_payload,
    encode_ok_vsearch, encode_vdel, encode_vget, encode_vindex_create, encode_vindex_drop,
    encode_vindex_list, encode_vsearch, encode_vset, f32_vec_to_bytes,
};
